...
$().ready(function (e) {
    ...
    if (outlineType == "OTC01") {
        strMapMedia = '<iframe id="map" src="https://barunsonmcard.com/Mcard/NaverMap/' + invitationId + '" width="750" height="320" frameborder="0" style="border: 0" allowfullscreen></iframe>';
    }
    else {
       ...
       // alert($("#Message").val());
        ...
        $.ajax({
            ...
            beforeSend: function (xhr) {
                xhr.setRequestHeader("Origin","barunsonmcard.com");
            },
            success: function (o) {
